...
REPO_URL="https://github.com/elyasmoshirpanahi/openclaw-docker"
COMPOSE_URL="https://raw.githubusercontent.com/elyasmoshirpanahi/openclaw-docker/main/docker-compose.yml"
...
print_banner() {
    ...
    echo "║         |_|                                                  ║"
    echo "║                                                              ║"
    echo "║              Docker Installer by elyasmoshirpanahi                   ║"
    echo "║                                                              ║"
    echo "╚══════════════════════════════════════════════════════════════╝"
    echo -e "${NC}"
}
