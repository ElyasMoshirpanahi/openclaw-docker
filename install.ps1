...
#
# Or with options:
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/elyasmoshirpanahi/openclaw-docker/main/install.ps1))) -NoStart
#
...
# Config
$Image = "ghcr.io/elyasmoshirpanahi/openclaw-docker:latest"
$RepoUrl = "https://github.com/elyasmoshirpanahi/openclaw-docker"
$ComposeUrl = "https://raw.githubusercontent.com/elyasmoshirpanahi/openclaw-docker/main/docker-compose.yml"
...
function Write-Banner {
    ...
    Write-Host "║                                                              ║" -ForegroundColor Red
    Write-Host "║              Docker Installer by elyasmoshirpanahi                   ║" -ForegroundColor Red
    Write-Host "║                                                              ║" -ForegroundColor Red
    Write-Host "╚══════════════════════════════════════════════════════════════╝" -ForegroundColor Red
    Write-Host ""
}
